  ...
  return (
    <div className="font-display bg-background-dark text-white min-h-screen flex flex-col relative overflow-hidden">
      ...
      <div className="relative z-10 flex-1 flex items-center justify-center p-4 sm:p-8">
        {/* Main Glass Card */}
        <div className="glass-card w-full max-w-md rounded-[2.5rem] p-8 sm:p-12 flex flex-col items-center gap-6">
          {/* Logo Header */}
          ...
          <form className="w-full flex flex-col gap-4">
            ...
            <div className="group relative">
              ...
              <input
                className="w-full bg-black/20 border border-white/10 rounded-full py-3.5 pl-12 pr-4 text-white placeholder-slate-500 focus:outline-none focus:border-primary/50 focus:ring-1 focus:ring-primary/50 transition-all font-medium"
                placeholder={activeRole === "student" ? "Student ID" : "Staff ID"}
                type="text"
              />
            </div>
            ...
            {/* Terms Agreement */}
            <div className="flex items-start gap-2 px-2 text-xs sm:text-sm">
          ...
          <div className="text-center">
            <p className="text-slate-400 text-sm">
              ...
              <Link href="/auth/login" className="text-white font-bold hover:underline decoration-primary decoration-2 underline-offset-4 ml-1">
                Sign In
              </Link>
            </p>
          </div>
